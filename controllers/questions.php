...
include_once __DIR__ . '/../models/testprep.php';
...
if ($_REQUEST['action'] === 'index') {
  ...
  $request_body = file_get_contents('php://input');
  $body_object= json_decode($request_body);
  $update_question = new Question($_REQUEST['id'], $body_object->question, $body_object->answer1, $body_object->answer2, $body_object->answer3, $body_object->answer4, $body_object->tags, $body_object->correctanswer);
